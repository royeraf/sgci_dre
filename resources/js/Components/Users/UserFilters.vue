    ...
    <div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" :value="filters.search"
                        ...
                        class="cursor-pointer w-full pl-10 pr-4 py-2.5 border-2 border-slate-200 rounded-xl bg-white text-slate-900 placeholder:text-slate-400 focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 text-sm outline-none" />
                </div>
            </div>
            ...
            <div>
                ...
                <select :value="filters.role"
                    ...
                    class="cursor-pointer outline-none w-full px-4 py-2.5 border-2 border-slate-200 rounded-xl bg-white text-slate-900 focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 text-sm">
        ...
        <div class="flex items-center justify-between mt-4 pt-4 border-t border-slate-100">
            ...
            <button @click="$emit('clear')"
                class="cursor-pointer outline-none text-sm font-semibold text-slate-500 hover:text-indigo-600 transition-colors duration-200 flex items-center gap-1">
                <X class="w-4 h-4" />
                Limpiar filtros
            </button>
        </div>
