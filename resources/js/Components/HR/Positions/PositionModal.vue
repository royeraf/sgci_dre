                ...
                <form @submit.prevent="onSubmit" class="p-6 space-y-6">
                    <div>
                        ...
                        <input v-model="nombre" type="text" placeholder="Ej. Especialista Administrativo"
                            class="w-full px-4 py-2.5 border-2 rounded-xl text-slate-900 placeholder:text-slate-400 focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-200 outline-none"
                    ...
                    <div>
                        ...
                        <textarea v-model="descripcion" rows="3" placeholder="Funciones o requisitos del cargo..."
                            class="w-full px-4 py-3 border-2 border-slate-200 rounded-xl bg-white text-slate-900 placeholder:text-slate-400 focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-200 outline-none resize-none"></textarea>
                    </div>
